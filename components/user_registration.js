...
module.exports = function(controller) {
    ...
    controller.on('oauth:success', function(payload) {
        ...
        console.log('Got a successful login!', JSON.stringify(payload));
              ...
              if (err) {
                ...
                controller.storage.teams.save(team, function(err, id) {
                  if (err) {
                    ...
                    // now save the current user info
                    controller.storage.users.get(payload.identity.user_id, function(err, user) {
                      if (!user) {
                        user = {
                            id: payload.identity.user_id,
                      ...
                      user.bot = payload.bot;
                      controller.log('oauth result: ' + JSON.stringify(user));
